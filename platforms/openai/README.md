...
**If you are a teacher using ChatGPT on the website** → see `platforms/chatgpt-web/` instead.
Drag `platforms/chatgpt-web/TOS-skills.md` into a ChatGPT Project and you're done.
...
system_prompt = open("platforms/openai/system-prompt.md").read()
