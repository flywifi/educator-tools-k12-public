...
2. **Standards Alignment** — every item maps to a real, cited, **verified** standard
   (`shared/standards/`, `protocols/standards-verification.md`). Alignment is the point of an
...
Per `protocols/metadata-schema.md`, including standards cited, the objective measured, and
