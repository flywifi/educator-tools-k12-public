<!-- last_reviewed: 2026-08-16 | owner: document-parse-maintainer -->
# MAINTAINER — document-parse

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `document-parse` so a future maintainer keeps the intended scope.
