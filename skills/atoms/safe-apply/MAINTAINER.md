<!-- last_reviewed: 2026-06-27 | owner: safe-apply-maintainer -->
# MAINTAINER — safe-apply

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `safe-apply` so a future maintainer keeps the intended scope.
