<!-- last_reviewed: 2026-08-16 | owner: feedback-write-maintainer -->
# MAINTAINER — feedback-write

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `feedback-write` so a future maintainer keeps the intended scope.
