<!-- last_reviewed: 2026-08-16 | owner: progress-monitor-plan-maintainer -->
# MAINTAINER — progress-monitor-plan

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `progress-monitor-plan` so a future maintainer keeps the intended scope.
