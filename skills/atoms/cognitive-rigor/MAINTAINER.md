<!-- last_reviewed: 2026-06-27 | owner: cognitive-rigor-maintainer -->
# MAINTAINER — cognitive-rigor

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `cognitive-rigor` so a future maintainer keeps the intended scope.
