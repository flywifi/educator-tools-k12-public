<!-- last_reviewed: 2026-08-16 | owner: objective-write-maintainer -->
# MAINTAINER — atom-objective-write

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-objective-write` so a future maintainer keeps the intended scope.
