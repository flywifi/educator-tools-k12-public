<!-- last_reviewed: 2026-08-16 | owner: standards-match-maintainer -->
# MAINTAINER — atom-standards-match

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-standards-match` so a future maintainer keeps the intended scope.
