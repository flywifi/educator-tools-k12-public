<!-- last_reviewed: 2026-06-27 | owner: wizard-interview-maintainer -->
# MAINTAINER — wizard-interview

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `wizard-interview` so a future maintainer keeps the intended scope.
