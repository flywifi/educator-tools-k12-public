<!-- last_reviewed: 2026-08-16 | owner: warm-up-maintainer -->
# MAINTAINER — warm-up

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `warm-up` so a future maintainer keeps the intended scope.
