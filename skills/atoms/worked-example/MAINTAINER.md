<!-- last_reviewed: 2026-08-16 | owner: worked-example-maintainer -->
# MAINTAINER — worked-example

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `worked-example` so a future maintainer keeps the intended scope.
