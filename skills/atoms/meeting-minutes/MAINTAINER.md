<!-- last_reviewed: 2026-06-27 | owner: meeting-minutes-maintainer -->
# MAINTAINER — meeting-minutes

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `meeting-minutes` so a future maintainer keeps the intended scope.
