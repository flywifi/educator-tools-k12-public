<!-- last_reviewed: 2026-06-27 | owner: answer-key-maintainer -->
# MAINTAINER — answer-key

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `answer-key` so a future maintainer keeps the intended scope.
