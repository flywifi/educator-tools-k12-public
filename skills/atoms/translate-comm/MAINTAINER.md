<!-- last_reviewed: 2026-08-16 | owner: translate-comm-maintainer -->
# MAINTAINER — translate-comm

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `translate-comm` so a future maintainer keeps the intended scope.
