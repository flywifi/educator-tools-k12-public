<!-- last_reviewed: 2026-08-16 | owner: distractor-generate-maintainer -->
# MAINTAINER — distractor-generate

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `distractor-generate` so a future maintainer keeps the intended scope.
