<!-- last_reviewed: 2026-08-16 | owner: parent-comm-maintainer -->
# MAINTAINER — atom-parent-comm

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-parent-comm` so a future maintainer keeps the intended scope.
