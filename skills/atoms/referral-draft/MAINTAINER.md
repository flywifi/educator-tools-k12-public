<!-- last_reviewed: 2026-08-16 | owner: referral-draft-maintainer -->
# MAINTAINER — referral-draft

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `referral-draft` so a future maintainer keeps the intended scope.
