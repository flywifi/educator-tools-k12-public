<!-- last_reviewed: 2026-08-16 | owner: feed-validate-maintainer -->
# MAINTAINER — feed-validate

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `feed-validate` so a future maintainer keeps the intended scope.
