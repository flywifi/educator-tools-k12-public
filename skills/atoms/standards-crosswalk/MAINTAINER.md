<!-- last_reviewed: 2026-08-16 | owner: standards-crosswalk-maintainer -->
# MAINTAINER — standards-crosswalk

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `standards-crosswalk` so a future maintainer keeps the intended scope.
