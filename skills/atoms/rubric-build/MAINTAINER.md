<!-- last_reviewed: 2026-08-16 | owner: rubric-build-maintainer -->
# MAINTAINER — rubric-build

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `rubric-build` so a future maintainer keeps the intended scope.
