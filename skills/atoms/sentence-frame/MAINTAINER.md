<!-- last_reviewed: 2026-06-27 | owner: sentence-frame-maintainer -->
# MAINTAINER — sentence-frame

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `sentence-frame` so a future maintainer keeps the intended scope.
