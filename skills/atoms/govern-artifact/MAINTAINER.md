<!-- last_reviewed: 2026-06-27 | owner: govern-artifact-maintainer -->
# MAINTAINER — govern-artifact

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `govern-artifact` so a future maintainer keeps the intended scope.
