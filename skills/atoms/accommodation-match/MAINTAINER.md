<!-- last_reviewed: 2026-08-16 | owner: accommodation-match-maintainer -->
# MAINTAINER — accommodation-match

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `accommodation-match` so a future maintainer keeps the intended scope.
