<!-- last_reviewed: 2026-06-27 | owner: intervention-select-maintainer -->
# MAINTAINER — intervention-select

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `intervention-select` so a future maintainer keeps the intended scope.
