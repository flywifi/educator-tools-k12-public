<!-- last_reviewed: 2026-06-27 | owner: hook-maintainer -->
# MAINTAINER — hook

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `hook` so a future maintainer keeps the intended scope.
