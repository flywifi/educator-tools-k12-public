<!-- last_reviewed: 2026-06-27 | owner: meeting-agenda-maintainer -->
# MAINTAINER — meeting-agenda

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `meeting-agenda` so a future maintainer keeps the intended scope.
