<!-- last_reviewed: 2026-06-27 | owner: present-levels-maintainer -->
# MAINTAINER — present-levels

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `present-levels` so a future maintainer keeps the intended scope.
