<!-- last_reviewed: 2026-06-27 | owner: report-card-comment-maintainer -->
# MAINTAINER — report-card-comment

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `report-card-comment` so a future maintainer keeps the intended scope.
