<!-- last_reviewed: 2026-08-16 | owner: question-set-maintainer -->
# MAINTAINER — question-set

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `question-set` so a future maintainer keeps the intended scope.
