<!-- last_reviewed: 2026-06-27 | owner: graphic-organizer-maintainer -->
# MAINTAINER — graphic-organizer

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `graphic-organizer` so a future maintainer keeps the intended scope.
