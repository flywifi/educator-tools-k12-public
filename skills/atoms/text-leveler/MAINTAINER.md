<!-- last_reviewed: 2026-08-16 | owner: text-leveler-maintainer -->
# MAINTAINER — text-leveler

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `text-leveler` so a future maintainer keeps the intended scope.
