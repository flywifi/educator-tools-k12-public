<!-- last_reviewed: 2026-08-16 | owner: activity-generate-maintainer -->
# MAINTAINER — atom-activity-generate

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-activity-generate` so a future maintainer keeps the intended scope.
