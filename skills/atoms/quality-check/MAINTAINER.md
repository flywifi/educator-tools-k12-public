<!-- last_reviewed: 2026-08-16 | owner: quality-check-maintainer -->
# MAINTAINER — atom-quality-check

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-quality-check` so a future maintainer keeps the intended scope.
