<!-- last_reviewed: 2026-08-16 | owner: differentiate-maintainer -->
# MAINTAINER — atom-differentiate

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-differentiate` so a future maintainer keeps the intended scope.
