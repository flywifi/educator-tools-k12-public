<!-- last_reviewed: 2026-08-16 | owner: behavior-strategy-maintainer -->
# MAINTAINER — behavior-strategy

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `behavior-strategy` so a future maintainer keeps the intended scope.
