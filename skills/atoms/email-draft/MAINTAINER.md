<!-- last_reviewed: 2026-06-27 | owner: email-draft-maintainer -->
# MAINTAINER — email-draft

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `email-draft` so a future maintainer keeps the intended scope.
