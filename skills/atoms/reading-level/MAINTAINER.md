<!-- last_reviewed: 2026-08-16 | owner: reading-level-maintainer -->
# MAINTAINER — atom-reading-level

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-reading-level` so a future maintainer keeps the intended scope.
