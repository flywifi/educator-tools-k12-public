<!-- last_reviewed: 2026-08-16 | owner: iep-goal-maintainer -->
# MAINTAINER — atom-iep-goal

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `atom-iep-goal` so a future maintainer keeps the intended scope.
