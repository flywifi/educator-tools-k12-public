<!-- last_reviewed: 2026-08-16 | owner: vocabulary-select-maintainer -->
# MAINTAINER — vocabulary-select

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `vocabulary-select` so a future maintainer keeps the intended scope.
