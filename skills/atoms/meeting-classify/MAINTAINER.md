<!-- last_reviewed: 2026-06-27 | owner: meeting-classify-maintainer -->
# MAINTAINER — meeting-classify

## Purpose
`SKILL.md` is the runtime contract; this file preserves non-negotiable behavior for `meeting-classify` so a future maintainer keeps the intended scope.
