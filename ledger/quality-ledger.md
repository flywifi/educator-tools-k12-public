...
|---|---|---|---|---|---|---|
| qr-2026-0001 | 2026-06-20 | lp-grade3-fractions-001 | lesson-planner | Approved | 4.34 | `skills/educator/lesson-planner/examples/grade3-fractions-lesson.md` |
...
- Note: these are bundled gold examples; live usage will add real decisions (incl. Rejected ones,
  e.g., a fabricated-standard case → Rejected per `skills/core/quality-review/examples/example-evaluation.md`).
