...
|---|---|---|
| `grade3-fractions-bundle.md` | Teaching bundle | lesson + rubric + slide deck + parent note, one shared standard |

Every bundle is decision support — each piece keeps `human_review_required: true`, placeholders only.
